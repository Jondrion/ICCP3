In Figure \ref{fig:flow1} the fluid flow velocity is plotted. Parabolic behaviour is observed closer to the edges as is expected. Now let's see what happens to the flow profile if objects are placed in the flow.
