...
\usepackage{multicol,graphicx,latexsym,amsmath,amssymb,amsthm,listings,pdfpages,epstopdf,alltt,enumerate,wrapfig}
...
\begin{figure}[ht!]
\centering
\includegraphics[width=1.0\textwidth]{plots/voorblad.pdf}
\label{fig:voorblad}
\end{figure}
\pagebreak
